...
var FleurPilotSettingTab = class extends import_obsidian2.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian2.Setting(containerEl).setName($("settings.baseUrl")).setDesc($("settings.baseUrlDesc")).addText((text) => text.setPlaceholder($("settings.baseUrlPlaceholder")).setValue(this.plugin.settings.baseUrl).onChange(async (value) => {
      this.plugin.settings.baseUrl = value;
      await this.plugin.saveSettings();
    }));
    new import_obsidian2.Setting(containerEl).setName($("settings.apiKey")).setDesc($("settings.apiKeyDesc")).addText((text) => {
      text.setPlaceholder($("settings.apiKeyPlaceholder")).setValue(this.plugin.settings.apiKey).onChange(async (value) => {
        this.plugin.settings.apiKey = value;
        await this.plugin.saveSettings();
      });
      text.inputEl.type = "password";
    });
    new import_obsidian2.Setting(containerEl).setName($("settings.model")).setDesc($("settings.modelDesc")).addText((text) => text.setPlaceholder($("settings.modelPlaceholder")).setValue(this.plugin.settings.model).onChange(async (value) => {
      this.plugin.settings.model = value;
      await this.plugin.saveSettings();
    }));
    new import_obsidian2.Setting(containerEl).setName($("settings.reasoningModel")).setDesc($("settings.reasoningModelDesc")).addText((text) => text.setPlaceholder($("settings.reasoningModelPlaceholder")).setValue(this.plugin.settings.reasoningModel).onChange(async (value) => {
    ...
    new import_obsidian2.Setting(containerEl).setName($("settings.systemPrompt")).setDesc($("settings.systemPromptDesc")).addTextArea((text) => {
      text.setPlaceholder($("settings.systemPromptPlaceholder")).setValue(this.plugin.settings.systemPrompt).onChange(async (value) => {
    ...
    new import_obsidian2.Setting(containerEl).setName($("settings.temperature")).setDesc($("settings.temperatureDesc")).addSlider((slider) => slider.setLimits(0, 1, 0.1).setValue(this.plugin.settings.temperature).setDynamicTooltip().onChange(async (value) => {
      this.plugin.settings.temperature = value;
      await this.plugin.saveSettings();
    }));
    new import_obsidian2.Setting(containerEl).setName($("settings.maxTokens")).setDesc($("settings.maxTokensDesc")).addSlider((slider) => slider.setLimits(512, 16384, 512).setValue(this.plugin.settings.maxTokens).setDynamicTooltip().onChange(async (value) => {
      this.plugin.settings.maxTokens = value;
      await this.plugin.saveSettings();
    }));
    new import_obsidian2.Setting(containerEl).setName($("settings.featureSettings")).setHeading();
    new import_obsidian2.Setting(containerEl).setName($("settings.enableContext")).setDesc($("settings.enableContextDesc")).addToggle((toggle) => toggle.setValue(this.plugin.settings.enableContext).onChange(async (value) => {
      this.plugin.settings.enableContext = value;
      await this.plugin.saveSettings();
    }));
    new import_obsidian2.Setting(containerEl).setName($("settings.enableInlineEdit")).setDesc($("settings.enableInlineEditDesc")).addToggle((toggle) => toggle.setValue(this.plugin.settings.enableInlineEdit).onChange(async (value) => {
      this.plugin.settings.enableInlineEdit = value;
      await this.plugin.saveSettings();
    }));
    new import_obsidian2.Setting(containerEl).setName($("settings.enableQuickCommands")).setDesc($("settings.enableQuickCommandsDesc")).addToggle((toggle) => toggle.setValue(this.plugin.settings.enableQuickCommands).onChange(async (value) => {
    ...
    new import_obsidian2.Setting(containerEl).setName($("settings.enableChatHistory")).setDesc($("settings.enableChatHistoryDesc")).addToggle((toggle) => toggle.setValue(this.plugin.settings.enableChatHistory).onChange(async (value) => {
    ...
    new import_obsidian2.Setting(containerEl).setName($("settings.testConnection")).setDesc($("settings.testConnectionDesc")).addButton((btn) => btn.setButtonText($("settings.testBtn")).setCta().onClick(async () => {
