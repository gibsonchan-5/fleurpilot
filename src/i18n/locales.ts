...
const zhCN: LocaleDict = {
    ...
    'settings.applyPreset': '应用预设配置',
    'settings.applyPresetDesc': '切换提供商后点击，自动填充对应的 Base URL 和模型名称',
    ...
    'settings.apiKeyDesc': '模型 API 密钥，保存在系统钥匙串，不写入 data.json',
    'settings.apiKeyDescSystem': '模型 API 密钥，已保存在系统钥匙串，不会写入 data.json，也不会随 vault 同步',
    'settings.apiKeyDescVault': '模型 API 密钥，当前以明文保存在 data.json，会随 vault 同步到其他设备',
    'settings.apiKeyDescUnavailable': '模型 API 密钥，当前 Obsidian 版本不支持系统钥匙串，将以明文保存在 data.json',
    'settings.secretModeName': '密钥保存位置',
    'settings.secretModeDesc': '系统钥匙串更安全，但密钥不进 vault，每台设备需各自填写；data.json 可随 vault 同步给多台设备共用，代价是密钥以明文保存在仓库中',
    'settings.secretModeUnavailable': '当前 Obsidian 版本不支持系统钥匙串，密钥只能明文保存在 data.json',
    'settings.secretModeOptionSystem': '系统钥匙串（推荐）',
    'settings.secretModeOptionVault': 'data.json（随 vault 同步）',
    ...
    'settings.enableInlineContext': '改写时携带本笔记上下文',
    'settings.enableInlineContextDesc': '润色 / 扩写 / 精简 / 续写时，自动把当前笔记全文作为参考上下文一起发给 AI',
    'settings.inlinePolishPrompt': '润色提示词',
    'settings.inlineExpandPrompt': '扩写提示词',
    'settings.inlineShortenPrompt': '精简提示词',
    'settings.inlineContinuePrompt': '续写提示词',
    'settings.inlinePromptDesc': '自定义该动作的 AI 指令，留空使用内置默认',
    'settings.inlinePromptPlaceholder': '留空使用内置默认提示词',
    ...
    'notice.secretMovedSystem': '密钥已移入系统钥匙串，data.json 中不再保存明文',
    'notice.secretMovedVault': '密钥将以明文保存在 data.json，并随 vault 同步',
    'notice.secretMoveFailed': '密钥移入系统钥匙串失败，已保持原设置',
    ...
    'inline.original': '原文',
    'inline.result': '改写结果',
    'inline.contextNote': '上下文：本笔记《{name}》',
    'inline.contextNone': '上下文：未启用',
    'inline.contextLoading': '正在读取上下文...',
    'inline.contextCustom': '上下文：自定义（{count} 个来源）',
    'inline.contextMenuActive': '当前笔记',
    'inline.contextMenuCustom': '文件夹或笔记…',
    'inline.contextMenuNone': '不使用上下文',
    'inline.loading': '正在改写...',
    'inline.cancel': '取消',
    'inline.apply': '应用修改',
    'inline.applied': '已应用修改',
    // 续写专用文案（语义是"接着写"，不是"改写"）
    'inline.titleContinue': '续写',
    'inline.originalContinue': '已有内容',
    'inline.loadingContinue': '正在续写...',
    'inline.applyContinue': '插入续写内容',
    'inline.appliedContinue': '已插入续写内容',
    'inline.followUpHint': '（对改写结果提更多要求）',
    'inline.followUpHintContinue': '（对续写内容提更多要求）',
...
const zhTW: LocaleDict = {
    ...
    'settings.applyPreset': '套用預設設定',
    'settings.applyPresetDesc': '切換供應商後點擊，自動填入對應的 Base URL 與模型名稱',
    'settings.baseUrl': 'API Base URL',
    'settings.baseUrlDesc': 'OpenAI 相容介面位址（不含 /chat/completions）',
    'settings.baseUrlPlaceholder': 'https://api.deepseek.com/v1',
    'settings.apiKey': 'API Key',
    'settings.apiKeyDesc': '模型 API 金鑰，儲存在系統鑰匙圈，不寫入 data.json',
    'settings.apiKeyDescSystem': '模型 API 金鑰，已儲存在系統鑰匙圈，不會寫入 data.json，也不會隨 vault 同步',
    'settings.apiKeyDescVault': '模型 API 金鑰，目前以明文儲存在 data.json，會隨 vault 同步到其他裝置',
    'settings.apiKeyDescUnavailable': '模型 API 金鑰，目前 Obsidian 版本不支援系統鑰匙圈，將以明文儲存在 data.json',
    'settings.secretModeName': '密鑰儲存位置',
    'settings.secretModeDesc': '系統鑰匙圈更安全，但密鑰不進 vault，每台裝置需各自填寫；data.json 可隨 vault 同步給多台裝置共用，代價是密鑰以明文儲存在倉庫中',
    'settings.secretModeUnavailable': '目前 Obsidian 版本不支援系統鑰匙圈，密鑰只能明文儲存在 data.json',
    'settings.secretModeOptionSystem': '系統鑰匙圈（建議）',
    'settings.secretModeOptionVault': 'data.json（隨 vault 同步）',
    'settings.apiKeyPlaceholder': 'sk-...',
    'settings.model': '模型名稱',
    ...
    'settings.enableInlineContext': '改寫時攜帶本筆記上下文',
    'settings.enableInlineContextDesc': '潤色 / 擴寫 / 精簡 / 續寫時，自動把當前筆記全文作為參考上下文一起發給 AI',
    'settings.inlinePolishPrompt': '潤色提示詞',
    'settings.inlineExpandPrompt': '擴寫提示詞',
    'settings.inlineShortenPrompt': '精簡提示詞',
    'settings.inlineContinuePrompt': '續寫提示詞',
    'settings.inlinePromptDesc': '自訂該動作的 AI 指令，留空使用內建預設',
    'settings.inlinePromptPlaceholder': '留空使用內建預設提示詞',
    ...
    'notice.secretMovedSystem': '密鑰已移入系統鑰匙圈，data.json 中不再保存明文',
    'notice.secretMovedVault': '密鑰將以明文保存在 data.json，並隨 vault 同步',
    'notice.secretMoveFailed': '密鑰移入系統鑰匙圈失敗，已保持原設置',
    ...
    'inline.original': '原文',
    'inline.result': '改寫結果',
    'inline.contextNote': '上下文：本筆記《{name}》',
    'inline.contextNone': '上下文：未啟用',
    'inline.contextLoading': '正在讀取上下文...',
    'inline.contextCustom': '上下文：自訂（{count} 個來源）',
    'inline.contextMenuActive': '當前筆記',
    'inline.contextMenuCustom': '資料夾或筆記…',
    'inline.contextMenuNone': '不使用上下文',
    'inline.loading': '正在改寫...',
    'inline.cancel': '取消',
    'inline.apply': '套用修改',
    ...
    // 續寫專用文案
    'inline.titleContinue': '續寫',
    'inline.originalContinue': '已有內容',
    'inline.loadingContinue': '正在續寫...',
    'inline.applyContinue': '插入續寫內容',
    'inline.appliedContinue': '已插入續寫內容',
    'inline.followUpHint': '（對改寫結果提更多要求）',
    'inline.followUpHintContinue': '（對續寫內容提更多要求）',
...
const en: LocaleDict = {
    ...
    'settings.applyPresetDesc': 'Click after changing provider to auto-fill Base URL and model name',
    'settings.baseUrl': 'API Base URL',
    'settings.baseUrlDesc': 'OpenAI-compatible endpoint (without /chat/completions)',
    'settings.baseUrlPlaceholder': 'https://api.deepseek.com/v1',
    'settings.apiKey': 'API Key',
    'settings.apiKeyDesc': 'Model API key, stored in the system keychain, not written to data.json',
    'settings.apiKeyDescSystem': 'Model API key, stored in the system keychain. It is never written to data.json and never syncs with the vault.',
    'settings.apiKeyDescVault': 'Model API key, currently stored in plain text inside data.json and synced to your other devices with the vault.',
    'settings.apiKeyDescUnavailable': 'Model API key. This Obsidian version does not support the system keychain, so it will be stored in plain text in data.json.',
    'settings.secretModeName': 'Secret storage',
    'settings.secretModeDesc': 'The system keychain is safer, but the key never enters the vault, so each device needs its own copy. data.json syncs with the vault for multi-device use, at the cost of plain-text storage.',
    'settings.secretModeUnavailable': 'This Obsidian version does not support the system keychain; the key can only be stored in plain text in data.json.',
    'settings.secretModeOptionSystem': 'System keychain (recommended)',
    'settings.secretModeOptionVault': 'data.json (syncs with vault)',
    'settings.apiKeyPlaceholder': 'sk-...',
    ...
    'settings.enableInlineContext': 'Attach note context when rewriting',
    'settings.enableInlineContextDesc': 'Send the full current note as reference context when polishing / expanding / shortening / continuing',
    'settings.inlinePolishPrompt': 'Polish prompt',
    'settings.inlineExpandPrompt': 'Expand prompt',
    'settings.inlineShortenPrompt': 'Shorten prompt',
    'settings.inlineContinuePrompt': 'Continue prompt',
    'settings.inlinePromptDesc': 'Custom instruction for this action; leave empty to use the built-in default',
    'settings.inlinePromptPlaceholder': 'Leave empty to use the built-in prompt',
    ...
    'command.continue': 'Continue writing',
    ...
    'menu.expand': 'Expand',
    'menu.continue': 'Continue writing',
    ...
    'notice.secretMovedSystem': 'Key moved into the system keychain; data.json no longer stores it in plain text',
    'notice.secretMovedVault': 'The key will be stored in plain text in data.json and sync with the vault',
    'notice.secretMoveFailed': 'Failed to move the key into the system keychain; the previous setting was kept',
    ...
    'inline.contextNote': 'Context: {name}',
    'inline.contextNone': 'Context: off',
    'inline.contextLoading': 'Reading context...',
    'inline.contextCustom': 'Context: custom ({count} sources)',
    'inline.contextMenuActive': 'Current note',
    'inline.contextMenuCustom': 'Folder or note…',
    'inline.contextMenuNone': 'No context',
    'inline.loading': 'Rewriting...',
    'inline.cancel': 'Cancel',
    'inline.apply': 'Apply',
    'inline.applied': 'Changes applied',
    // Continue-writing specific labels
    'inline.titleContinue': 'Continue writing',
    'inline.originalContinue': 'Existing content',
    'inline.loadingContinue': 'Continuing...',
    'inline.applyContinue': 'Insert continuation',
    'inline.appliedContinue': 'Continuation inserted',
    'inline.followUpHint': '(ask for changes to the result)',
    'inline.followUpHintContinue': '(ask for changes to the continuation)',
...
const ja: LocaleDict = {
    ...
    'settings.applyPresetDesc': 'プロバイダー変更後にクリックすると、対応する Base URL とモデル名が自動入力されます',
    'settings.baseUrl': 'API ベースURL',
    'settings.baseUrlDesc': 'OpenAI互換エンドポイント（/chat/completions を除く）',
    'settings.baseUrlPlaceholder': 'https://api.deepseek.com/v1',
    'settings.apiKey': 'API キー',
    'settings.apiKeyDesc': 'モデルAPIキーはシステムキーチェーンに保存されます（data.json には書き込みません）',
    'settings.apiKeyDescSystem': 'モデルAPIキーはシステムキーチェーンに保存され、data.json には書き込まれず、vault とも同期されません',
    'settings.apiKeyDescVault': 'モデルAPIキーは現在 data.json 内に平文で保存され、vault と同期して他のデバイスに共有されます',
    'settings.apiKeyDescUnavailable': 'モデルAPIキー。この Obsidian バージョンはシステムキーチェーンに対応していないため、data.json に平文で保存されます',
    'settings.secretModeName': 'シークレットの保存先',
    'settings.secretModeDesc': 'システムキーチェーンはより安全ですが、キーは vault に入らないため、デバイスごとに入力が必要です。data.json は vault と同期して複数デバイスで共有できますが、平文で保存されます',
    'settings.secretModeUnavailable': 'この Obsidian バージョンはシステムキーチェーンに対応していないため、キーは data.json に平文で保存されます',
    'settings.secretModeOptionSystem': 'システムキーチェーン（推奨）',
    'settings.secretModeOptionVault': 'data.json（vault と同期）',
    'settings.apiKeyPlaceholder': 'sk-...',
    'settings.model': 'モデル名',
    ...
    'settings.enableInlineContext': '書き換え時にノートのコンテキストを添付',
    'settings.enableInlineContextDesc': '推敲 / 拡張 / 短縮 / 続きを書く際、現在のノート全文を参考コンテキストとして AI に送信',
    'settings.inlinePolishPrompt': '推敲プロンプト',
    'settings.inlineExpandPrompt': '拡張プロンプト',
    'settings.inlineShortenPrompt': '短縮プロンプト',
    'settings.inlineContinuePrompt': '続きを書くプロンプト',
    'settings.inlinePromptDesc': 'この操作の AI 指示をカスタマイズ。空欄で内蔵デフォルトを使用',
    'settings.inlinePromptPlaceholder': '空欄で内蔵デフォルトのプロンプトを使用',
    ...
    'notice.secretMovedSystem': 'キーをシステムキーチェーンに移動しました。data.json には平文で保存されません',
    'notice.secretMovedVault': 'キーは data.json に平文で保存され、vault と同期されます',
    'notice.secretMoveFailed': 'システムキーチェーンへの移動に失敗したため、元の設定を維持しました',
    ...
    'inline.original': '原文',
    'inline.result': '結果',
    'inline.contextNote': 'コンテキスト：本ノート《{name}》',
    'inline.contextNone': 'コンテキスト：なし',
    'inline.contextLoading': 'コンテキストを読み込み中...',
    'inline.contextCustom': 'コンテキスト：カスタム（{count} 件）',
    'inline.contextMenuActive': '現在のノート',
    'inline.contextMenuCustom': 'フォルダーまたはノート…',
    'inline.contextMenuNone': 'コンテキストなし',
    'inline.loading': '書き換え中...',
    'inline.cancel': 'キャンセル',
    'inline.apply': '適用',
    'inline.applied': '変更を適用しました',
    // 続き書き専用の文言
    'inline.titleContinue': '続きを書く',
    'inline.originalContinue': '既存の内容',
    'inline.loadingContinue': '続きを書いています...',
    'inline.applyContinue': '続きを挿入',
    'inline.appliedContinue': '続きを挿入しました',
    'inline.followUpHint': '（書き換え結果に追加の要望を）',
    'inline.followUpHintContinue': '（続きの内容に追加の要望を）',
