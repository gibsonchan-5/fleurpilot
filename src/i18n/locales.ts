...
const zhCN: LocaleDict = {
    ...
    'chat.skillSummarizePrompt': '请对当前笔记的全文进行总结，提炼核心观点和关键信息，生成简洁的摘要（200-300字），保持逻辑清晰、结构完整。',
...
const zhTW: LocaleDict = {
    ...
    'chat.skillSummarizePrompt': '請對當前筆記的全文進行總結，提煉核心觀點和關鍵信息，生成簡潔的摘要（200-300字），保持邏輯清晰、結構完整。',
...
const en: LocaleDict = {
    ...
    'chat.skillSummarizePrompt': 'Please summarize the full text of the current note, extracting key points and core information to generate a concise summary (200-300 words), maintaining clear logic and complete structure.',
